...
public class Picture extends SimplePicture 
{
    ...
    //method to keep only blue values in picture
    ...
    public void fixUnderwater(){
        ...
        for(Pixel[] rowArray : pixels){
            for(Pixel pixelObj : rowArray){
                ...
                avg = (pixelObj.getGreen() + pixelObj.getRed())/2;
                pixelObj.setGreen(avg+40);
                pixelObj.setRed(avg+10);
